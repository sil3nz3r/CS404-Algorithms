    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (k = 1; k <= size; k++)
            {
                ...
                //Console.WriteLine(String.Format("MyDist[{0}]: ", k));
                //Helper.PrintMatrix(MyDist[k]);

                //Console.WriteLine(String.Format("FirstStop[{0}]: ", k));
                //Helper.PrintMatrix(FirstStop[k]);

                //Console.WriteLine(String.Format("LastStop[{0}]: ", k));
                //Helper.PrintMatrix(LastStop[k]);
            ...
            //Console.WriteLine(String.Format("TotalFlow: ", k));
            //Helper.PrintIntMatrix(TotalFlow, 2);
